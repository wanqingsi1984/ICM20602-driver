...
//	
//	GPIO_InitStruct.Pin = I2C_SCL_PIN | I2C_SDA_PIN | I2C_CS_PIN | I2C_AD0_PIN;
...
void I2C_WriteOneByteSlow(uint8_t DevAddr, uint8_t RegAddr, uint8_t Data)
{
	I2C_StartSlow();
	I2C_WriteByteSlow(DevAddr | I2C_Direction_Transmitter);
	I2C_WaiteForAckSlow();
	I2C_WriteByteSlow(RegAddr);
	I2C_WaiteForAckSlow();
	I2C_WriteByteSlow(Data);
	I2C_WaiteForAckSlow();
	I2C_StopSlow();
...
uint8_t I2C_ReadOneByteSlow(uint8_t DevAddr, uint8_t RegAddr)
{
	uint8_t TempVal = 0;
	...
	I2C_WaiteForAckSlow();
	I2C_StartSlow();
	I2C_WriteByteSlow(DevAddr | I2C_Direction_Receiver);
	I2C_WaiteForAckSlow();
	TempVal = I2C_ReadByteSlow(I2C_NACK);
	I2C_StopSlow();
	return TempVal;
	
}

#define SLOW_DELAY_US 5
void I2C_StartSlow(void)
{
	//I2C_SDAMode(I2C_SDA_OUT);
	I2C_SDA_Set();
...
void I2C_WriteByteSlow(uint8_t Data)
{
	uint8_t i;
...
uint8_t I2C_ReadByteSlow(uint8_t Ack)
{
	uint8_t i, RecDat = 0;
